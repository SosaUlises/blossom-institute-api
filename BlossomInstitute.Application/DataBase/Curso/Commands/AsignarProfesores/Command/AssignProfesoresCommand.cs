...
{
    public class AssignProfesoresCommand : IAssignProfesoresCommand
    {
        private readonly IDataBaseService _db;
        private readonly UserManager<UsuarioEntity> _userManager;

        public AssignProfesoresCommand(
            IDataBaseService db,
        ...
        public async Task<BaseResponseModel> Execute(int cursoId, AssignProfesoresModel model, CancellationToken ct = default)
        {
            if (cursoId <= 0)
